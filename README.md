...
![MARKETING](https://i.ibb.co/kc9f44b/5.png)

# Version 1.0.0

Sistema de verificacion de uso de licencia en tiempo de ejecucion

# COMPLEMENTO DE Kernel Sistemas externos
...
Si ya adquirio nuestro aplicativo offline ya se dio cuenta que la estructura de nuestro aplicativo se compone de 3 directorios o carpetas y 1 archivo index.html quedando algo de la siguiente manera:
